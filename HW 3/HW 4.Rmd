...
Bartlett's test - Bartlett's test yields a p-value close to 0, which indicates that we should reject the null hypothesis that the model has been reduced to white noise. 
...
**Fit and analysis of ARIMA(0,1,1)(0,1,2)12**
...
Yes, the ARIMA model produced reduction to white noise.

Residuals vs. Time Plot - The residuals vs. time plot shows a flat residuals accross time, suggesting that trend has been sufficiently captured. We also do not see fluctuations which indicate the presence of seasonality, suggesting that seasonality has also been captured by our mode.
